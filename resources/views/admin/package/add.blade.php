        ...
        <div class="col-xl-12 col-lg-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Add Package</h5>
                </div>
                <div class="card-body">

                    <form class="form-horizontal" action="{{ route('admin.package.insert') }}" method="POST"
                        enctype="multipart/form-data" id="update-package">
                        @csrf
                        <div class="mb-3">
                            <label for="package" class="form-label">Package</label>
                            <input type="text" class="form-control @error('package') is-invalid @enderror" id="package"
                                value="{{ old('package') }}" name="package" autofocus placeholder="Enter package">
                            @error('package')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('price') is-invalid @enderror" id="price"
                                value="{{ old('price') }}" name="price" autofocus placeholder="Enter price">
                            @error('price')
